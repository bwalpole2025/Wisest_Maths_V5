...
const tiles = [
  { icon: Library, label: "Total questions", value: stats.total, sub: "fully worked", tint: "from-[#1565c0]/15 to-[#42a5f5]/10 text-[#1565c0]" },
  { icon: Layers3, label: "Subtopics", value: stats.subtopics, sub: "Year 1 Pure", tint: "from-[#0a3580]/15 to-[#1565c0]/10 text-[#0a3580]" },
  { icon: ListChecks, label: "Solution steps", value: stats.steps.toLocaleString(), sub: "with intuition", tint: "from-emerald-500/15 to-teal-500/10 text-emerald-700" },
  { icon: Flame, label: "Hard questions", value: stats.hard, sub: "for stretch", tint: "from-rose-500/15 to-orange-500/10 text-rose-700" },
];

export default function DashboardPage() {
  const diff = [
    { label: "Easy", value: stats.easy, color: "bg-emerald-500", text: "text-emerald-700" },
    { label: "Intermediate", value: stats.intermediate, color: "bg-amber-500", text: "text-amber-700" },
    { label: "Hard", value: stats.hard, color: "bg-rose-500", text: "text-rose-700" },
  ];
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
          <Reveal>
            <div className="glass flex h-full flex-col rounded-3xl p-7">
              ...
              <div className="mt-7 flex h-3 overflow-hidden rounded-full bg-black/[0.06]">
                {diff.map((d) => (
